...
syn match nagiosMacro  '\$CONTACT\(NAME\|ALIAS\|EMAIL\|PAGER\|GROUPNAME\|GROUPNAMES\)\$'
syn match nagiosMacro  '\$CONTACTGROUP\(ALIAS\|MEMBERS\)\$'
...
syn match nagiosMacro  '\$\(PROCESSS\|EVENT\)STARTTIME\$'
syn match nagiosMacro  '\$LASTHOST\(UP\|DOWN\)\$'
...
syn keyword nagiosDirective contained host_notification_period hostgroups hostgroup_members hostgroup_name
syn keyword nagiosDirective contained servicegroup_name servicegroups servicegroup_members
